...
A simple Obsidian plugin that lets you **right-click any external link** and replace it directly with the response from an public API 

Current used API: [is.gd](https://is.gd

Fully working in Source mode 
Haven not been tested properly on Live Preview and Reading view modes (never need it)
